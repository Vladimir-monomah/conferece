...
// !!! yconfs
require_once('YconfsApp.php');
$yconfsApp = new YconfsApp();
$fileExts = $yconfsApp->fileExts();
$_GET['lang'] = $yconfsApp->language();
$_SESSION['RF']['language'] = $yconfsApp->language(); 
$_SESSION['RF']['language_file'] = 'lang/' . $_SESSION['RF']['language'] . '.php';
$_SESSION['RF']['subfolder'] = $yconfsApp->subfolder();
...
$config = array(
	...
	*/
	...
	|
	*/
	'upload_dir' => '/' . $yconfsApp->uploadDir() . '/',
	...
	|
	*/
	'current_path' => '../' .  $yconfsApp->uploadDir() . '/',
	...
	|
	*/
	'thumbs_base_path' => '../' . $yconfsApp->thumbsBasePath() . '/',
	...
	*/
	...
	'access_keys' => $yconfsApp->accessKeys(),
	...
	|
	*/
	'MaxSizeUpload' => $yconfsApp->getMaxSizeUpload(),
	...
	|--------------------------------------------------------------------------
	*/
	'default_language' => $yconfsApp->defaultLanguage(),
	...
	*/
	...
	//**********************
	'ext_img'                                 => array_intersect(array( 'jpg', 'jpeg', 'png', 'gif', 'bmp', 'tiff', 'svg' ), $fileExts), //Images
	'ext_file'                                => array_intersect(array( 'doc', 'docx', 'rtf', 'pdf', 'xls', 'xlsx', 'txt', 'csv', 'html', 'xhtml', 'psd', 'sql', 'log', 'fla', 'xml', 'ade', 'adp', 'mdb', 'accdb', 'ppt', 'pptx', 'odt', 'ots', 'ott', 'odb', 'odg', 'otp', 'otg', 'odf', 'ods', 'odp', 'css', 'ai', 'tex' ), $fileExts), //Files
	'ext_video'                               => array_intersect(array( 'mov', 'mpeg', 'm4v', 'mp4', 'avi', 'mpg', 'wma', "flv", "webm", "ogv", "swf" ),$fileExts), //Video
	'ext_music'                               => array_intersect(array( 'mp3', 'm4a', 'ac3', 'aiff', 'mid', 'ogg', 'wav' ),$fileExts), //Audio
	'ext_misc'                                => array_intersect(array( 'zip', 'rar', 'gz', 'tar', 'iso', 'dmg' ),$fileExts), //Archives
	...
	'fixed_path_from_filemanager'             => array(),//array( 'thumbs/', 'thumbs/','thumbs/','thumbs/' ), //fixed path of the image folder from the current position on upload folder
	'fixed_image_creation_name_to_prepend'    => array(),// array( 'thumb_', 'thumb_','thumb_','thumb_' ), //name to prepend on filename
	'fixed_image_creation_to_append'          => array(),//array( '_100', '_170', '_200', '_230' ), //name to appendon filename
	'fixed_image_creation_width'              => array(),//array( 100, 170, 200, 230 ), //width of image (you can leave empty if you set height)
	'fixed_image_creation_height'             => array(),//array( 100, 170, 200, 230 ), //height of image (you can leave empty if you set width)
	/*
	#             $option:     0 / exact = defined size;
	#                          1 / portrait = keep aspect set height;
	#                          2 / landscape = keep aspect set width;
	...
	#                          4 / crop= resize and crop;
	 */
	'fixed_image_creation_option'             => array( 'crop', 'auto', 'auto', 'auto' ), //set the type of the crop
	...
	'relative_path_from_current_pos'          => array( 'thumbs/', 'thumbs/','thumbs/','thumbs/' ), //relative path of the image folder from the current position on upload folder
	'relative_image_creation_name_to_prepend' => array( 'thumb_','thumb_','thumb_','thumb_' ), //name to prepend on filename
	'relative_image_creation_name_to_append'  => array( '_100','_170','_200','_230' ), //name to append on filename
	'relative_image_creation_width'           => array( 100, 170, 200, 230 ), //width of image (you can leave empty if you set height)
	'relative_image_creation_height'          => array( 100, 170, 200, 230 ), //height of image (you can leave empty if you set width)
	/*
	#             $option:     0 / exact = defined size;
	#                          1 / portrait = keep aspect set height;
	#                          2 / landscape = keep aspect set width;
	...
	#                          4 / crop= resize and crop;
	 */
	'relative_image_creation_option'          => array( 'crop','auto','auto','auto' ), //set the type of the crop
