	...
	<script>
	    ...
	    Dropzone.options.rfmDropzone = {
		    ...
		    dictResponseError: "SERVER ERROR",
                    dictDefaultMessage: "<?php echo trans('Drop_files_here_to_upload');?>",
    ...
    <div class="navbar-inner">
		...
		<div class="filters">
			...
			<div class="span4 half">
			    <?php if($upload_files){ ?>
						    <button class="tip btn upload-btn" title="<?php echo  trans('Upload_file'); ?>" style="vertical-align: text-top;"><i class="rficon-upload"></i>&nbsp;<?php echo  trans('Upload_file'); ?></button>
			    <?php } ?>
...
<!-- header div end -->
	...
	<?php //<li class="pull-right"><a class="btn-small" href="javascript:void('')" id="change_lang_btn"><i class="icon-globe"></i></a></li> ?>
...
?>
            ...
            ?>		<figure data-name="<?php echo $file ?>" data-type="<?php if($is_img){ echo "img"; }else{ echo "file"; } ?>">
				...
				<figcaption>
				    ...
				    <?php }else{ ?>
				    <?php //<a class="preview disabled"><i class="icon-eye-open icon-white"></i></a> ?>
				    <?php } ?>
