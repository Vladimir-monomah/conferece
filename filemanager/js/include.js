...
!function(e, a, t) {
    ...
    function i() {
        ...
        bootbox.dialog(a, [{label: e("#cancel").val(), "class": "btn"}, {label: e("#ok").val(), "class": "btn-inverse", callback: function() {
                    ...
                    if (null !== a) {
                        ...
                        e.ajax({type: "POST", url: "execute.php?action=create_file", data: {path: n, path_thumb: i, name: a, new_content: t}}).done(function(a) {
    ...
    function r(a) {
        ...
        e.ajax({type: "POST", url: "ajax_calls.php?action=get_file&sub_action=edit&preview_mode=text", data: {path: n}}).done(function(i) {
            bootbox.dialog(i, [{label: e("#cancel").val(), "class": "btn"}, {label: e("#ok").val(), "class": "btn-inverse", callback: function() {
                        var a = e("#textfile_edit_area").val();
                        e.ajax({type: "POST", url: "execute.php?action=save_text_file", data: {path: n, path_thumb: t, new_content: a}}).done(function(e) {
                            "" != e && bootbox.alert(e)
                        })
    ...
    function l(a) {
        ...
        var t, n;
        a.hasClass("directory") ? (t = a.find(".rename-folder").attr("data-thumb"), n = a.find(".rename-folder").attr("data-path")) : (t = a.find(".rename-file").attr("data-thumb"), n = a.find(".rename-file").attr("data-path")), e.ajax({type: "POST", url: "ajax_calls.php?action=chmod", data: {path: n, path_thumb: t}}).done(function(a) {
            bootbox.dialog(a, [{label: e("#cancel").val(), "class": "btn"}, {label: e("#ok").val(), "class": "btn-inverse", callback: function() {
                        var a = e("#chmod_form #chmod_value").val();
                        if ("" != a && "undefined" != typeof a) {
                            var i = e("#chmod_form input[name=apply_recursive]:checked").val();
                            ("" == i || "undefined" == typeof i) && (i = "none"), e.ajax({type: "POST", url: "execute.php?action=chmod", data: {path: n, path_thumb: t, new_mode: a, is_recursive: i}}).done(function(e) {
                                "" != e && bootbox.alert(e)
                            })
                        }
    ...
    function c(a) {
        ...
        if (t.user = 0, t.group = 0, t.all = 0, "undefined" != typeof a && 1 == a) {
            ...
            e("#chmod_form input:checkbox:checked").each(function() {
                var a = e(this).attr("data-group"), n = e(this).attr("data-value");
    ...
    function p(a, t) {
        if ("copy" == t || "cut" == t) {
            var n, i;
            a.hasClass("directory") ? (n = a.find(".rename-folder").attr("data-thumb"), i = a.find(".rename-folder").attr("data-path")) : (n = a.find(".rename-file").attr("data-thumb"), i = a.find(".rename-file").attr("data-path")), e.ajax({type: "POST", url: "ajax_calls.php?action=copy_cut", data: {path: i, path_thumb: n, sub_action: t}}).done(function(a) {
    ...
    function f(a) {
        bootbox.confirm(e("#lang_paste_confirm").val(), e("#cancel").val(), e("#ok").val(), function(t) {
            if (1 == t) {
                var n, i;
                "undefined" != typeof a ? (n = a.find(".rename-folder").attr("data-path"), i = a.find(".rename-folder").attr("data-thumb")) : (n = e("#sub_folder").val() + e("#fldr_value").val(), i = e("#cur_dir_thumb").val()), e.ajax({type: "POST", url: "execute.php?action=paste_clipboard", data: {path: n, path_thumb: i}}).done(function(a) {
    ...
    function u(a, t) {
        ...
        a.parent().hide(100), e.ajax({type: "POST", url: "ajax_calls.php?action=copy_cut", data: {path: r, path_thumb: i, sub_action: "cut"}}).done(function(n) {
            if ("" != n)
                bootbox.alert(n);
            else {
                var i, r;
                "undefined" != typeof t ? t.hasClass("back-directory") ? (i = t.find(".path").val(), r = t.find(".path_thumb").val()) : (i = t.find(".rename-folder").attr("data-path"), r = t.find(".rename-folder").attr("data-thumb")) : (i = e("#sub_folder").val() + e("#fldr_value").val(), r = e("#cur_dir_thumb").val()), e.ajax({type: "POST", url: "execute.php?action=paste_clipboard", data: {path: i, path_thumb: r}}).done(function(t) {
    ...
    function v(t) {
        ...
        if (e(".uploader").css("width", n), i.val() > 0) {
            if (1 == i.val())
                e("ul.grid li, ul.grid figure").css("width", "100%");
            else {
    ...
    function _() {
        1 == e("#popup").val() ? window.close() : (parent.$(".modal").modal("hide"), "undefined" != typeof parent.jQuery && parent.jQuery ? "function" == typeof parent.jQuery.fancybox && parent.jQuery.fancybox.close() : "function" == typeof parent.$.fancybox && parent.$.fancybox.close())
    }
    function g(e) {
        for (var e, a = [/[\300-\306]/g, /[\340-\346]/g, /[\310-\313]/g, /[\350-\353]/g, /[\314-\317]/g, /[\354-\357]/g, /[\322-\330]/g, /[\362-\370]/g, /[\331-\334]/g, /[\371-\374]/g, /[\321]/g, /[\361]/g, /[\307]/g, /[\347]/g], t = ["A", "a", "E", "e", "I", "i", "O", "o", "U", "u", "N", "n", "C", "c"], n = 0; n < a.length; n++)
            e = e.replace(a[n], t[n]);
        return e
    }
    function y(a) {
    ...
    function w(a, t, n, i, r, o) {
        null !== i && (i = y(i), e.ajax({type: "POST", url: "execute.php?action=" + a, data: {path: t, path_thumb: n, name: i.replace("/", "")}}).done(function(e) {
    ...
    function x(a, t) {
        ...
        n.each(function() {
            ...
            if (e.isNumeric(n))
                for (n = parseFloat(n); "undefined" != typeof r[n] && r[n]; )
                    n = parseFloat(parseFloat(n) + parseFloat(.001));
            else
                n = n + "a" + a.find("h4 a").attr("data-file");
            r[n] = a.html(), o.push(n)
        }), i.each(function() {
            var a = e(this), n = a.find(t).val();
            if (e.isNumeric(n))
                for (n = parseFloat(n); "undefined" != typeof l[n] && l[n]; )
                    n = parseFloat(parseFloat(n) + parseFloat(.001));
            else
                n = n + "a" + a.find("h4 a").attr("data-file");
            l[n] = a.html(), c.push(n)
    ...
    var j = "9.9.3", T = !0, I = 0, O = function() {
        var e = 0;
        return function(a, t) {
        ...
        return"" != n && null != n && (t += n), n = a.find("h4 a.folder-link").attr("data-file"), "" != n && null != n && (t += n), t
                ...
                bootbox.prompt(e("#lang_duplicate").val(), e("#cancel").val(), e("#ok").val(), function(e) {
                    if (null !== e && (e = y(e), e != t)) {
                        ...
                        w("duplicate_file", n.attr("data-path"), n.attr("data-thumb"), e, n, "apply_file_duplicate")
                    }
                }, t)
            }, select: function(a) {
                var t, n = S(a), i = e("#field_id").val();
                if (t = 1 == e("#popup").val() ? window.opener : window.parent, "" != i)
                    if (1 == e("#crossdomain").val())
                        t.postMessage({sender: "responsivefilemanager", url: n, field_id: i}, "*");
                    else {
                        var r = e("#" + i, t.document);
                        r.val(n).trigger("change"), "function" == typeof t.responsive_filemanager_callback && t.responsive_filemanager_callback(i), _()
                    }
                else
                    apply_any(n)
            }, copy: function(e) {
            ...
            t.on("click", ".modalAV", function(a) {
                ...
                bootbox.prompt(e("#rename").val(), e("#cancel").val(), e("#ok").val(), function(e) {
                    var te = e;
                    if ("true" == $("#transliteration").val()) {
                        e = transliterate(te);
                    } else {
                        e = te;
                    }
                    ;
                    null !== e && (e = y(e), e != i && w("rename_file", a.attr("data-path"), a.attr("data-thumb"), e, t, "apply_file_rename"))
                }, i)
            }), t.on("click", ".rename-folder", function() {
                var a = e(this), t = a.parent().parent().parent(), n = t.find("h4"), i = e.trim(n.text());
                bootbox.prompt(e("#rename").val(), e("#cancel").val(), e("#ok").val(), function(e) {
                    null !== e && (e = y(e).replace(".", ""), e != i && w("rename_folder", a.attr("data-path"), a.attr("data-thumb"), e, t, "apply_folder_rename"))
                }, i)
            }), t.on("click", ".delete-file", function() {
                var a = e(this);
                bootbox.confirm(a.attr("data-confirm"), e("#cancel").val(), e("#ok").val(), function(e) {
                    1 == e && (w("delete_file", a.attr("data-path"), a.attr("data-thumb"), "", "", ""), a.parent().parent().parent().parent().remove())
                })
            }), t.on("click", ".delete-folder", function() {
                var a = e(this);
                bootbox.confirm(a.attr("data-confirm"), e("#cancel").val(), e("#ok").val(), function(e) {
                    1 == e && (w("delete_folder", a.attr("data-path"), a.attr("data-thumb"), "", "", ""), a.parent().parent().parent().remove())
                })
    ...
    e(document).ready(function() {
        ...
        }), U.bindGridEvents(), parseInt(e("#file_number").val()) > parseInt(e("#file_number_limit_js").val()))
            var t = !1;
        else
            var t = !0;
        if (U.makeSort(t), U.makeFilters(t), e("#info").on("click", function() {
            ...
            bootbox.prompt(e("#insert_folder_name").val(), e("#cancel").val(), e("#ok").val(), function(a) {
                if (null !== a) {
                    ...
                    e.ajax({type: "POST", url: "execute.php?action=create_folder", data: {path: t, path_thumb: n}}).done(function() {
                        setTimeout(function() {
                            window.location.href = e("#refresh").attr("href") + "&" + (new Date).getTime()
                        }, 300)
                    })
        ...
        e(window).resize(function() {
            v(28)
        }), v(14), m(1 == e("#clipboard").val() ? !0 : !1), e("li.dir, li.file").draggable({distance: 20, cursor: "move", helper: function() {
        ...
        c = c.toLowerCase();
        var d = "", s = ["ogg", "mp3", "wav"], p = ["mp4", "ogv", "webm"], f = e("#return_relative_url").val(), u = encodeURL((1 == f ? r : o + i) + a);
        if ("" != t)
            if (1 == e("#crossdomain").val())
                n.postMessage({sender: "responsivefilemanager", url: u, field_id: t}, "*");
            else {
            ...
            e.inArray(c, ext_img) > -1 ? d = '<img src="' + u + '" alt="' + l + '" />' :
                c == 'swf'? d = '<object data="' + u + '" type="application/x-shockwave-flash"></object>' :
                c == 'flv'? d = '<embed src="' + parent.tinymce.activeEditor.settings.sfu_media_jwplayer +'" flashvars="file=' + u +'" type="application/x-shockwave-flash"></embed>' :
                e.inArray(c, p) > -1 ? d = '<video controls source src="' + u + '" type="video/' + c + '">' + l + "</video>" : 
                e.inArray(c, s) > -1 ? ("mp3" == c && (c = "mpeg"), d = '<audio controls src="' + u + '" type="audio/' + c + '">' + l + "</audio>") : 
                d = '<a href="' + u + '" title="' + l + '">' + l + "</a>", 1 == e("#crossdomain").val() ? 
                n.postMessage({sender: "responsivefilemanager", url: u, field_id: null, html: d}, "*") : 
                parent.tinymce.majorVersion < 4 ? (parent.tinymce.activeEditor.execCommand("mceInsertContent", !1, d), 
                parent.tinymce.activeEditor.windowManager.close(parent.tinymce.activeEditor.windowManager.params.mce_window_id)) : 
                (parent.tinymce.activeEditor.insertContent(d), parent.tinymce.activeEditor.windowManager.close())
        ...
        if ("" != t)
            if (1 == e("#crossdomain").val())
                n.postMessage({sender: "responsivefilemanager", url: c, field_id: t}, "*");
            else {
        ...
        if (1 == e("#crossdomain").val())
            window.parent.postMessage({sender: "responsivefilemanager", url: a, field_id: null}, "*");
        else {
            var t = e("#editor").val();
            if ("ckeditor" == t) {
                ...
                parent.tinymce.majorVersion < 4 ? (parent.tinymce.activeEditor.windowManager.params.setUrl(a), parent.tinymce.activeEditor.windowManager.close(parent.tinymce.activeEditor.windowManager.params.mce_window_id)) : (parent.tinymce.activeEditor.windowManager.getParams().setUrl(a), parent.tinymce.activeEditor.windowManager.close())
        }
