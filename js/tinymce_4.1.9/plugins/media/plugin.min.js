...
tinymce.PluginManager.add('media', function(editor, url) {
    var urlPatterns = [
        ...
        {regex: /video\.sfu-kras\.ru(.+)v=([^&]+)/, type: 'iframe', w: 610, h: 344, url: '//video.sfu-kras.ru/embed/$2'},
    ...
    function dataToHtml(data) {
        ...
        if (data.embed) {            
            ...
            if (data.type == "iframe") {
                ...
                if ((data.source1.indexOf('.flv') != -1) || (data.source1.indexOf(editor.settings.sfu_media_jwplayer) != -1)) {
                    html += '<embed src="' + editor.settings.sfu_media_jwplayer
                            + '" flashvars="file=' +  data.source1 + '&stretching=exactfit';
                    if (data.poster) {
                        html += '&image=' + data.poster
                                + '" poster="' + data.poster;
                    }
                    html += '" width="' + data.width + '" height="' + data.height + '" type="application/x-shockwave-flash"></embed>';
    ...
    function htmlToData(html) {
        ...
        if (data.source1 && (data.source1.indexOf(editor.settings.sfu_media_jwplayer) != -1)) {
            var s1 = data.flashvars.indexOf('=');
            var s2 = data.flashvars.indexOf('.flv');
            if ((s1 > 0) && (s2 > 0)) {
                data.source1 = data.flashvars.substring(s1 + 1, s2 + 4);
            }
        }
